...
namespace Lets_Module_Math {
	...
	void run() {
		...
		// Functions::set_lets_funcs("sin", new Lets_Modules_Math::Sin(), true);
		// Functions::set_lets_funcs("cos", new Lets_Modules_Math::Cos(), true);
		// Functions::set_lets_funcs("tan", new Lets_Modules_Math::Tan(), true);
		// Functions::set_lets_funcs("acos", new Lets_Modules_Math::Acos(), true);
		// Functions::set_lets_funcs("asin", new Lets_Modules_Math::Asin(), true);
		// Functions::set_lets_funcs("atan", new Lets_Modules_Math::Atan(), true);
		// Functions::set_lets_funcs("atan2", new Lets_Modules_Math::Atan2(), true);
		// Functions::set_lets_funcs("cosh", new Lets_Modules_Math::Cosh(), true);
		// Functions::set_lets_funcs("sinh", new Lets_Modules_Math::Sinh(), true);
		// Functions::set_lets_funcs("tanh", new Lets_Modules_Math::Tanh(), true);
		// Functions::set_lets_funcs("acosh", new Lets_Modules_Math::Acosh(), true);
		// Functions::set_lets_funcs("asinh", new Lets_Modules_Math::Asinh(), true);
		// Functions::set_lets_funcs("atanh", new Lets_Modules_Math::Atanh(), true);
	}
